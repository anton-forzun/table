document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePrices(isYearly) {
        ...
        document.querySelector('td[data-monthly="$19.99"]').textContent = standardPrice;
        document.querySelector('td[data-monthly="$29.99"]').textContent = premiumPrice;
        document.querySelector('td[monthly="Щомісячно"]').textContent = quantityCheck;
    }
});